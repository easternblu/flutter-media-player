...
public interface KhubRemoteToTvConstant {
     ...
     */
    @Deprecated
    String KHUB_REMOTE_TO_TV_BROADCAST_PARAM_CODE = "POPSICAL_REMOTE_TO_TV_BROADCAST_PARAM_CODE";
    ...
    /**
     * Corresponding to {@link KhubRemoteToTvConstant#POPSICAL_REMOTE_TO_TV_REQUEST}
     */
    @Deprecated
