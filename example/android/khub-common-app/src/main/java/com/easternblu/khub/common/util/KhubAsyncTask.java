 ...
 */
public abstract class KhubAsyncTask<Params, Progress, Result> extends AsyncTask<Params, Progress, Result> {
    ...
    private static final ThreadFactory sKhubThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
            return new Thread(r, "KhubAsyncTask #" + mCount.getAndIncrement());
        }
    };
...
//        RUNNING,
//        /**
//         * Indicates that {@link KhubAsyncTask#onPostExecute} has finished.
//         */
//        FINISHED,
//    }
//
...
//
//    @MainThread
//    public final KhubAsyncTask<Params, Progress, Result> execute(final Params... params) {
//        if (!isMainThread()) {
