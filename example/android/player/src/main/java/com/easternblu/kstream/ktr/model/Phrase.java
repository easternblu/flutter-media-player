package com.easternblu.kstream.ktr.model;

import android.os.Build;


import com.easternblu.kstream.ktr.FuriganaStringBuilder;
 ...
 * <p>
 * It can be one word or multiple. Even if it is one phrase per word. The user should use {@link com.easternblu.kstream.ktr.PhraseJoiner} after the conversion to simplify the actual phrases
