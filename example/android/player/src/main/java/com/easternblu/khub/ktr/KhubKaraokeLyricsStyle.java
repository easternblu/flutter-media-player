...
/**
 * A class to consolidate the custom visual style Khub content team wanted
 */
public class KhubKaraokeLyricsStyle {
     ...
     */
    public KhubKaraokeLyricsStyle(Context ctx, Typeface coolVeticaRegular, Typeface cloudYuanCuGBK) {
        this.ctx = ctx;
