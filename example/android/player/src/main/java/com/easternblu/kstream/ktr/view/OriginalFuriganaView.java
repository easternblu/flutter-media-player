...
public class OriginalFuriganaView extends View {
...
//        }
        ...
        // Draw
        public float draw(Canvas canvas, float x, float y) {
            Paint p = m_is_marked ? m_paint_k_mark : m_paint_k_norm;

          //  p.setStyle(Paint.Style.FILL);
            canvas.drawText(m_text, 0, m_text.length(), x, y, p);
//            int currentTextColor = getCurrentTextColor();
//
//            p.setStyle(Paint.Style.STROKE);
//            p.setStrokeWidth(_strokeWidth);
//            setTextColor(_strokeColor);
    ...
    // Constructors
    public OriginalFuriganaView(Context context) {
        super(context);
    }

    public OriginalFuriganaView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public OriginalFuriganaView(Context context, AttributeSet attrs, int style) {
        super(context, attrs, style);
    }

    // Text functions
    public void setText(TextPaint tp, String text, int mark_s, int mark_e) {
        // Text
