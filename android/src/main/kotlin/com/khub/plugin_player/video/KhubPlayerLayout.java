...
public class KhubPlayerLayout extends PlayerView implements FlutterAVPlayer {
    ...
    private final String TAG = "KhubPlayerLayout";
    /**
    ...
    public KhubPlayerLayout(Context context) {
        super(context);
    }

    public KhubPlayerLayout(@NonNull Context context,
    ...
    private void setupMediaSession() {
        ...
        mMediaSessionCompat = new MediaSessionCompat(context,
                KhubPlayerLayout.class.getSimpleName(), receiver, null);
